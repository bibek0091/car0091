...
YOLO_MODEL_FILE = os.path.join(_ASSETS_DIR, "best.onnx")  # Only ONNX model supported
...
# --- ADAS EXPERIMENTAL FEATURE FLAGS ---
# STEP 3: PROTECTION STRATEGY (Feature Flags)
ENABLE_SMOOTH_CONFIDENCE = True
